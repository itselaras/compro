        ...
        <section class="side-section">
            ...
            <div class="panel">
                ...
                <div class="panel-body text-right">
                    ...
                    <p class="text-right">
                        Kelola data lamaran dan update terus informasi kesempatan berkarir.
                    </p>
                    <div>
                        <a class="btn btn-success" href="data-lamaran">Data Lamaran</a>
                    </div>
                </div>
                <div class="panel-footer">
                    <div>
                        <a class="pull-left read-more" href="akun-setting">Konfigurasi Akun</a>
                            ...
                            while ($agenda = mysql_fetch_array($query)) {
                                ...
                                ?>
                                    <div class="pengumuman-list">
                                        ...
                                        <span class="read-more text-muted"><i class="fa fa-calendar calendar-width"></i>Posted on <?php echo $agenda['updated_at']; ?></span>
                                    </div>
                                <?php
                                }
                                $i++;
