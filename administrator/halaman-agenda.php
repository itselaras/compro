...
<div id="page-wrapper">
    ...
    <a href="halaman-agenda-form?act=Tambah" class="btn btn-primary"><i class="fa fa-plus-square fa-fw"></i> Tambah Data</a>
    <hr>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        data = $('#my-table').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "halaman-agenda-tbl",
            "bPaginate": true,
            "bSort": true,
            "bAutoWidth": false,
        ...
        $('#my-table').on('click', '.delete', function(event) {
            ...
            bootbox.confirm("Yakin hapus data ini?", function(result) {
                ...
                {
                    $.ajax({
                        url: 'halaman-agenda-act?act=hapus',
                        type: 'POST',
                        data: {
                            id: that.data('id'),
