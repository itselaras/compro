...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-desktop"></i> Pengembangan Organisasi</h1>
        </div>
    </div>
    ...
    <div class="container-edit invisible">
        ...
        <div class="form-group">
            <label>Pengembangan Organisasi</label>
            <textarea class="form-control" id="halaman-pengembangan" name="halaman-pengembangan"></textarea>
        </div>
...
<script type="text/javascript">
    function loadData(){
        $.ajax({
            ...
            dataType: 'json',
            data: {
                field: 'pengembangan_organisasi'
            }
        })
        .done(function(data) {
            console.log("success");
            $('.container-konten').html(data.view);
            CKEDITOR.instances['halaman-pengembangan'].setData(data.ckeditor);
        })
        .fail(function() {
            console.log("error");
        })
    ...
    $(document).ready(function() {
        loadData();
        CKEDITOR.replace( 'halaman-pengembangan', {
            toolbar : [
        ...
        $('.btn-update').click(function(event) {
            $.ajax({
                ...
                type: 'POST',
                data: {
                    konten: CKEDITOR.instances['halaman-pengembangan'].getData(),
                    field: 'pengembangan_organisasi',
