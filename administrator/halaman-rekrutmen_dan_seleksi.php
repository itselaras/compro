...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-desktop"></i> Rekrutmen dan Seleksi</h1>
        </div>
    </div>
    ...
    <div class="container-edit invisible">
        ...
        <div class="form-group">
            <label>Rekrutmen dan Seleksi</label>
            <textarea class="form-control" id="halaman-rekrutmen" name="halaman-rekrutmen"></textarea>
        </div>
...
<script type="text/javascript">
    function loadData(){
        $.ajax({
            ...
            dataType: 'json',
            data: {
                field: 'rekrutmen_dan_seleksi'
            }
        })
        .done(function(data) {
            console.log("success");
            $('.container-konten').html(data.view);
            CKEDITOR.instances['halaman-rekrutmen'].setData(data.ckeditor);
        })
        .fail(function() {
            console.log("error");
        })
    ...
    $(document).ready(function() {
        loadData();
        CKEDITOR.replace( 'halaman-rekrutmen', {
            toolbar : [
        ...
        $('.btn-update').click(function(event) {
            $.ajax({
                ...
                type: 'POST',
                data: {
                    konten: CKEDITOR.instances['halaman-rekrutmen'].getData(),
                    field: 'rekrutmen_dan_seleksi',
