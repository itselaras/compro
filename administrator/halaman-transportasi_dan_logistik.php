...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-desktop"></i> Transportasi dan Logistik</h1>
        </div>
    </div>
    ...
    <div class="container-edit invisible">
        ...
        <div class="form-group">
            <label>Transportasi dan Logistik</label>
            <textarea class="form-control" id="halaman-transportasi" name="halaman-transportasi"></textarea>
        </div>
...
<script type="text/javascript">
    function loadData(){
        $.ajax({
            ...
            dataType: 'json',
            data: {
                field: 'transportasi_dan_logistik'
            }
        })
        .done(function(data) {
            console.log("success");
            $('.container-konten').html(data.view);
            CKEDITOR.instances['halaman-transportasi'].setData(data.ckeditor);
        })
        .fail(function() {
            console.log("error");
        })
    ...
    $(document).ready(function() {
        loadData();
        CKEDITOR.replace( 'halaman-transportasi', {
            toolbar : [
        ...
        $('.btn-update').click(function(event) {
            $.ajax({
                ...
                type: 'POST',
                data: {
                    konten: CKEDITOR.instances['halaman-transportasi'].getData(),
                    field: 'transportasi_dan_logistik',
