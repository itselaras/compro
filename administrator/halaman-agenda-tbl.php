<?php
         ...
         */
        $aColumns = array( "tb_agenda.id", "tb_agenda.judul", "'option'");

        /* Indexed column (used for fast and accurate table cardinality) */
        $sIndexColumn = "tb_agenda.id";

        /* DB table to use */
        $aTable = array( "tb_agenda" );
