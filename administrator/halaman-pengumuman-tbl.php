<?php
         ...
         */
        $aColumns = array( "tb_pengumuman.id", "tb_pengumuman.judul_pengumuman", "'option'");

        /* Indexed column (used for fast and accurate table cardinality) */
        $sIndexColumn = "tb_pengumuman.id";

        /* DB table to use */
        $aTable = array( "tb_pengumuman" );
