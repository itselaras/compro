...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-desktop"></i> Assessment Center</h1>
        </div>
    </div>
    ...
    <div class="container-edit invisible">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="halaman-assessment" name="halaman-assessment"></textarea>
        </div>
...
<script type="text/javascript">
    function loadData(){
        $.ajax({
            ...
            dataType: 'json',
            data: {
                field: 'assessment_center'
            }
        })
        .done(function(data) {
            console.log("success");
            $('.container-konten').html(data.view);
            CKEDITOR.instances['halaman-assessment'].setData(data.ckeditor);
        })
        .fail(function() {
            console.log("error");
        })
    ...
    $(document).ready(function() {
        loadData();
        CKEDITOR.replace( 'halaman-assessment', {
            toolbar : [
        ...
        $('.btn-update').click(function(event) {
            $.ajax({
                ...
                type: 'POST',
                data: {
                    konten: CKEDITOR.instances['halaman-assessment'].getData(),
                    field: 'assessment_center',
