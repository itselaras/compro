...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-desktop"></i> Labor Supply</h1>
        </div>
    </div>
    ...
    <div class="container-edit invisible">
        ...
        <div class="form-group">
            <label>Labor Supply</label>
            <textarea class="form-control" id="labor-supply" name="labor-supply"></textarea>
        </div>
...
<script type="text/javascript">
    function loadData(){
        ...
        .done(function(data) {
            ...
            CKEDITOR.instances['labor-supply'].setData(data.ckeditor);
        })
        .fail(function() {
            console.log("error");
        })
    ...
    $(document).ready(function() {
        ...
        $('.btn-update').click(function(event) {
            $.ajax({
                ...
                type: 'POST',
                data: {
                    konten: CKEDITOR.instances['labor-supply'].getData(),
                    field: 'labor_supply',
